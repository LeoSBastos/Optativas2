...
import 'package:login_firebase/component/cria_dropdown.dart';
import 'package:login_firebase/component/cria_textfield.dart';
import 'package:login_firebase/controller/curso_controller.dart';
...
class _CadastroCursoState extends State<CadastroCurso> {
  ...
  _salvar(BuildContext context) async {
    User user = await _cursoController.cursoDao.getUser();
    if (user == null) {
