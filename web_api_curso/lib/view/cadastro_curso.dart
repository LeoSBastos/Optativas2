...
import 'package:web_api_curso/component/cria_dropdown.dart';
import 'package:web_api_curso/component/cria_textfield.dart';
...
class _CadastroCursoState extends State<CadastroCurso> {
  CursoWebClient _cursoWebClient = new CursoWebClient();
  int _id;
